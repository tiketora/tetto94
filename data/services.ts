...
export interface ServiceConfig {
  ...
  /* ── Optional overrides — used when the default generated copy doesn't fit
     (e.g. avoids the "QUANTO COSTA IL [servizio]" grammar bug on services
     whose full name doesn't read naturally after "IL") ── */
  costHeading?: { white: string; red: string } // full override for the price-table H2
  costIntro?: string                            // override for the paragraph under that H2
  costNote?: string                             // override for the disclaimer paragraph under the table
  ctaHeading?: { white: string; red: string }   // full override for the final CTA banner title
  ogImage?: string                              // override OG image path (default: /images/og/{slug}.png)
  omitAggregateRating?: boolean                 // skip aggregateRating in this service's JSON-LD (no verified review data yet)
  /** Extra copy blocks rendered between "Il Servizio" and "Come Lavoriamo" —
   *  e.g. "I 3 metodi di coibentazione", "I materiali isolanti", "Detrazioni fiscali" */
  extraSections?: {
    kicker: string
    heading: { white: string; red: string }
    intro?: string
    blocks?: { title: string; body: string }[] // rendered as an H3 grid (e.g. the 3 methods)
...
export const SERVICES: ServiceConfig[] = [
  ...
  {
    slug: 'coibentazione-tetto',
    name: 'Coibentazione Tetto',
    nameFull: 'Coibentazione e Isolamento Termico del Tetto',
    headline: 'COIBENTAZIONE E ISOLAMENTO TETTO',
    subheadline:
      'Isoliamo tetti e sottotetti con pannelli, insufflaggio e tetti ventilati. Meno dispersione di calore, bollette più leggere, garanzia scritta 10 anni.',
    description:
      'Isolamento termico di tetto e sottotetto con materiali certificati CE. Sopralluogo drone gratuito, garanzia scritta 10 anni.',
    metaTitle: 'Coibentazione Tetto e Sottotetto | Isolamento Termico | Tetto94',
    metaDescription:
      "Coibentazione tetto e sottotetto nel Nord-Est: pannelli isolanti, insufflaggio, isolamento dall'interno e dall'esterno. Senza ponteggi, drone gratuito, garanzia 10 anni.",
    doveOperiamoIntro:
      'Coibentiamo tetti e sottotetti in tutto il Nord-Est Italia. Ecco le principali zone in cui interveniamo:',
    ogImage: '/images/hero-roof-mobile.png',
    omitAggregateRating: true,
    costHeading: { white: 'QUANTO COSTA LA', red: 'COIBENTAZIONE DEL TETTO?' },
    costIntro: 'Costi indicativi per il Nord-Est Italia, IVA e ponteggi esclusi. Sopralluogo drone gratuito, entro 24 ore.',
    costNote:
      "Il costo della coibentazione dipende dal metodo scelto e dallo stato della copertura. L'insufflaggio del sottotetto è l'intervento più economico e rapido; la coibentazione dall'esterno, spesso abbinata al rifacimento del manto, è quella con il risultato migliore e più duraturo. I prezzi sono indicativi, IVA e ponteggi esclusi: con noi i ponteggi in genere non servono, e questo abbassa il totale in modo significativo.",
    prezziTable: [
      { tipo: 'Tetto94: sopralluogo drone + preventivo', prezzoMin: 'Gratuito', prezzoMax: 'Entro 24h', note: 'Incluso in ogni intervento' },
      { tipo: 'Insufflaggio del sottotetto', prezzoMin: '€ 15/mq', prezzoMax: '€ 30/mq', note: "L'intervento più economico e rapido" },
      { tipo: "Isolamento dall'interno (pannelli sottocopertura o solaio)", prezzoMin: '€ 30/mq', prezzoMax: '€ 60/mq', note: 'Manto esterno non toccato' },
      { tipo: "Coibentazione dall'esterno (pannelli sopra la struttura)", prezzoMin: '€ 50/mq', prezzoMax: '€ 100/mq', note: 'Elimina i ponti termici' },
      { tipo: 'Coibentazione + rifacimento completo del manto', prezzoMin: '€ 100/mq', prezzoMax: '€ 150/mq', note: 'Isolamento e nuova copertura in un unico cantiere' },
    ],
    longDescription:
      "Un tetto non isolato è la prima causa di dispersione del calore di una casa: d'inverno il riscaldamento lavora il doppio, d'estate le stanze sotto la copertura diventano invivibili. Tetto94 realizza interventi di coibentazione su tetti e sottotetti in tutto il Nord-Est Italia: pannelli isolanti, insufflaggio e tetti ventilati, sempre con materiali certificati CE e garanzia scritta 10 anni. Il sopralluogo con drone è gratuito e lavoriamo senza ponteggi, con tecniche di accesso su fune certificate: meno costi e nessuna attesa per le autorizzazioni comunali.",
    icon: 'Thermometer',
    heroKeyword: 'COIBENTAZIONE',
    ctaHeading: { white: 'PRONTO A ISOLARE', red: 'IL TUO TETTO?' },
    extraSections: [
      {
        kicker: 'Metodi',
        heading: { white: 'I 3 METODI DI', red: 'COIBENTAZIONE' },
        blocks: [
          {
            title: "Coibentazione dall'esterno",
            body: "I pannelli isolanti vengono posati sopra la struttura del tetto, sotto il manto di copertura. È il metodo più efficace: elimina i ponti termici, protegge la struttura e non toglie un centimetro all'altezza dei locali interni. È la scelta ideale quando il manto va comunque sostituito, perché coibentazione e rifacimento avvengono in un unico cantiere.",
          },
          {
            title: 'Isolamento dall\'interno',
            body: "I pannelli si applicano all'intradosso della copertura o sul solaio, senza toccare tegole e coppi. Il cantiere è rapido, i costi sono contenuti e si interviene anche d'inverno. Va considerata una leggera riduzione dell'altezza nei locali mansardati.",
          },
          {
            title: 'Insufflaggio del sottotetto',
            body: "Se il sottotetto non è abitabile, il materiale isolante sfuso (cellulosa o lana minerale) viene insufflato direttamente sopra il solaio. Poche ore di lavoro, nessuna opera muraria e il miglior rapporto tra costo e beneficio: spesso è l'intervento di efficientamento più conveniente di tutta la casa.",
          },
        ],
      },
      {
        kicker: 'Materiali',
        heading: { white: 'I MATERIALI', red: 'ISOLANTI CHE UTILIZZIAMO' },
        body: "Non esiste un isolante migliore in assoluto: esiste quello giusto per la tua copertura. Utilizziamo lana di roccia e lana di vetro (traspiranti e resistenti al fuoco), fibra di legno (la migliore per il comfort estivo), XPS, EPS e poliuretano (massime prestazioni con spessori ridotti) e cellulosa per l'insufflaggio. Tutti materiali certificati CE, scelti in base a struttura, clima e obiettivo di risparmio. Lo spessore corretto, in genere tra 10 e 16 cm a seconda del materiale, viene definito durante il sopralluogo.",
      },
      {
        kicker: 'Bonus Fiscali',
        heading: { white: 'DETRAZIONI', red: 'FISCALI' },
        body: "La coibentazione del tetto è un intervento di efficientamento energetico e può accedere alle detrazioni fiscali (Ecobonus o bonus ristrutturazioni, in base al caso). Percentuali e massimali dipendono dal tipo di immobile e di intervento: ti aiutiamo a individuare l'agevolazione corretta e prepariamo la documentazione, senza costi aggiuntivi.",
      },
    ],
    faqItems: [
      {
        q: 'Quanto costa isolare un tetto di 100 mq?',
        a: "Dipende dal metodo: da circa 1.500-3.000 euro con l'insufflaggio del sottotetto, 3.000-6.000 euro con l'isolamento dall'interno, fino a 5.000-15.000 euro per la coibentazione dall'esterno con intervento sul manto. Il sopralluogo drone gratuito definisce la cifra esatta entro 24 ore.",
      },
      {
        q: 'Qual è il miglior isolante termico per un tetto?',
        a: "Non ce n'è uno migliore in assoluto: la lana di roccia è traspirante e ignifuga, la fibra di legno protegge dal caldo estivo, poliuretano e XPS isolano al massimo con pochi centimetri, la cellulosa è perfetta per l'insufflaggio. Scegliamo il materiale dopo il sopralluogo, in base a struttura e obiettivo.",
      },
      {
        q: 'Qual è il modo migliore per isolare il tetto?',
        a: "Se il sottotetto non è abitato, l'insufflaggio è il più rapido ed economico. Se è abitato, si isola dall'interno con pannelli oppure, per il risultato più duraturo, dall'esterno quando si interviene anche sul manto di copertura.",
      },
      {
        q: 'Che spessore deve avere la coibentazione del tetto?',
        a: "In genere tra 10 e 16 cm, in base al materiale e alla zona climatica; con isolanti ad alte prestazioni come il poliuretano bastano spessori inferiori. Il valore corretto si calcola sul singolo edificio durante il sopralluogo.",
      },
      {
        q: 'Si può isolare il tetto senza togliere le tegole?',
        a: "Sì: con l'isolamento dall'interno o con l'insufflaggio del sottotetto il manto non si tocca. La coibentazione dall'esterno, invece, si esegue quando le tegole vanno comunque rimosse o sostituite.",
      },
      {
        q: 'La coibentazione del tetto ha diritto a detrazioni?',
        a: "Sì, come intervento di efficientamento energetico può accedere alle detrazioni fiscali previste (Ecobonus o bonus ristrutturazioni, in base al caso). Ti aiutiamo a individuare l'agevolazione applicabile e gestiamo la documentazione.",
      },
    ],
    benefits: [
      'Sopralluogo drone gratuito con verifica dello stato della copertura',
      "Intervento senza ponteggi (risparmio fino all'80%)",
      'Materiali isolanti certificati CE',
      'Un solo interlocutore per coibentazione e rifacimento',
      'Assistenza sulle pratiche per le detrazioni',
      'Garanzia scritta 10 anni',
    ],
    steps: [
      { title: 'Sopralluogo Drone', desc: 'Analizziamo copertura e sottotetto e individuiamo le dispersioni.' },
      { title: 'Progetto e Preventivo', desc: 'Materiale, metodo e spessore giusti per il tuo tetto, preventivo entro 24 ore.' },
      { title: 'Posa Senza Ponteggi', desc: 'Intervento rapido con accesso su fune certificato.' },
      { title: 'Collaudo e Garanzia', desc: 'Verifica finale e garanzia scritta 10 anni.' },
    ],
    priceFrom: '',
  },
]
...
/* ─────────────────────────────────────────────────────────────
   INDEXED CITY PAGES — per service, which /[servizio]/[citta]
   combinations are robots: index,follow (and listed in sitemap.xml).
   Every other combination still renders (so internal links never 404)
   but stays noindex,nofollow. Single source of truth shared by
   app/[servizio]/[citta]/page.tsx and app/sitemap.ts.
───────────────────────────────────────────────────────────── */
export const INDEXED_CITY_PAGES: Record<string, Set<string>> = {
  'rifacimento-tetto': new Set([
    'venezia', 'mestre', 'padova', 'treviso', 'verona', 'vicenza',
    'rovigo', 'belluno', 'chioggia', 'mirano', 'san-dona-di-piave', 'mogliano-veneto',
  ]),
  'coibentazione-tetto': new Set([
    'venezia', 'mestre', 'padova', 'treviso', 'verona', 'vicenza',
    'rovigo', 'belluno', 'chioggia', 'mirano', 'san-dona-di-piave', 'mogliano-veneto',
  ]),
}
