...
export const LANDING_PAGES: LandingPageConfig[] = [
  ...
  {
    slug: 'coibentazione-tetto-veneto',
    pageId: 'lp_coibentazione_veneto',
    region: 'Veneto',
    regionShort: 'Veneto',
    h1: 'Coibentazione tetto in Veneto? Interveniamo senza ponteggi.',
    subheadline: 'Isoliamo tetto e sottotetto con sopralluogo drone gratuito e garanzia scritta 10 anni. Meno dispersione di calore, bollette più leggere.',
    metaTitle: 'Coibentazione Tetto Veneto · Tetto94 | Senza Ponteggi',
    metaDescription: 'Coibentazione tetto e sottotetto in Veneto senza ponteggi. Sopralluogo con drone gratuito, preventivo in 24h, garanzia scritta 10 anni. Richiedi ora.',
    url: 'https://www.tetto94.it/coibentazione-tetto-veneto',
  },
]
