    ...
    <section id="galleria" className="bg-[#161616] py-24 lg:py-32" ref={ref}>
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          {/* Heading — line 1 full width */}
          <h2 className="mt-2 font-display leading-none">
            <span className="block text-[clamp(2rem,5vw,4.2rem)] text-white font-black">
              PRIMA E DOPO.
            </span>

            {/* Line 2 + description inline on desktop */}
            <span className="flex flex-col sm:flex-row sm:items-end sm:gap-6">
              <span className="text-[clamp(2rem,5vw,4.2rem)] text-[#EB1C26] font-black leading-none shrink-0">
                LA DIFFERENZA SI VEDE.
              </span>
              <span className="mt-3 sm:mt-0 sm:pb-1 text-sm text-white leading-relaxed font-sans font-normal">
