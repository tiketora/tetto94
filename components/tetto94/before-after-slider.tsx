...
export default function BeforeAfterSlider({
  ...
  useEffect(() => {
    ...
    // passive: false is required so e.preventDefault() works on touchmove
  ...
  return (
    <div
      ref={containerRef}
      className="before-after-slider relative w-full aspect-[16/9] rounded-sm overflow-hidden cursor-ew-resize select-none touch-none"
      onMouseDown={(e) => {
        setIsDragging(true)
        updatePosition(e.clientX)
      }}
    ...
    >
      ...
      {/* Labels */}
      <div className="absolute bottom-4 left-4 bg-[#EB1C26] px-3 py-1.5">
        <span className="text-xs font-bold uppercase tracking-wider text-white">Prima</span>
      </div>
      <div className="absolute top-4 right-4 bg-[#EB1C26] px-3 py-1.5">
