...
// import { Menu, X, Phone, MapPin, ChevronDown, ChevronLeft, ArrowRight, Layers, Droplets, Hammer, CloudRain, Wind } from 'lucide-react'
...
//   return (
//     <>
//       <header className="fixed top-0 left-0 right-0 z-50 bg-[#161616] backdrop-blur-md shadow-2xl border-b border-white/5">
  ...
  return (
    <>
      <motion.header
        ...
        className="fixed top-0 left-0 right-0 z-50 bg-[#161616] backdrop-blur-md shadow-2xl border-b border-white/5"
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-2 md:py-4 overflow-visible">
