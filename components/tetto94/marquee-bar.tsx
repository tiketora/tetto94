...
export default function MarqueeBar() {
  return (
    <div className="relative bg-[#f5f5f5] overflow-hidden py-3 border-y border-black/8">
      {/* Left fade */}
      <div className="pointer-events-none absolute left-0 top-0 h-full w-16 z-10 bg-gradient-to-r from-[#f5f5f5] to-transparent" />
      {/* Right fade */}
      <div className="pointer-events-none absolute right-0 top-0 h-full w-16 z-10 bg-gradient-to-l from-[#f5f5f5] to-transparent" />
        ...
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs font-bold uppercase tracking-[0.18em] text-[#161616]">
                {item.text}
              </span>
