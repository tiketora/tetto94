                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="padding-right:14px;vertical-align:middle;">
                          <!-- T symbol simplified -->
                          <table cellpadding="0" cellspacing="0" border="0">
                            <tr><td style="width:36px;height:10px;background:#ffffff;display:block;"></td></tr>
                            <tr><td style="width:4px;height:0px;"></td></tr>
                            <tr>
                              <td style="padding-top:0;">
                                <table cellpadding="0" cellspacing="0" border="0"><tr>
                                  <td style="width:16px;"></td>
                                  <td style="width:10px;height:20px;background:#ffffff;"></td>
                                </tr></table>
                              </td>
                            </tr>
                          </table>
                        ...
                        <td style="vertical-align:middle;">
                          <span style="font-size:26px;font-weight:900;color:#ffffff;letter-spacing:-0.5px;line-height:1;">TETTO</span>
                          <span style="font-size:14px;font-weight:700;color:rgba(255,255,255,0.75);letter-spacing:2px;display:block;margin-top:2px;">DAL 94</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="text-align:right;white-space:nowrap;padding-left:16px;">
                    <p style="margin:0;font-size:11px;font-weight:700;color:rgba(255,255,255,0.15);letter-spacing:2px;">TETTO94</p>
                  </td>
                </tr>
              </table>
            </td>
