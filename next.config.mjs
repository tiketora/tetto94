...
//     imageSizes: [16, 32, 48, 64, 96, 128, 256, 384],
//     minimumCacheTTL: 31536000,
//     // Blog cover/inline images are uploaded through UploadThing and served
//     // from its UFS CDN domain.
//     remotePatterns: [
...
const nextConfig = {
  ...
  images: {
    ...
    minimumCacheTTL: 31536000,
    // Blog cover/inline images are uploaded through UploadThing and served
    // from either its newer per-app UFS CDN domain or the legacy shared
    // utfs.io domain, depending on the app/region.
    remotePatterns: [
      { protocol: 'https', hostname: '*.ufs.sh' },
