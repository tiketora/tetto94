    ...
    <>
      ...
      <main className="bg-background pt-24 pb-20">
        <div className="mx-auto max-w-6xl px-6">
          <Link
            href="/blog"
            className="mb-8 flex items-center gap-1.5 text-xs font-semibold text-muted-foreground transition-colors hover:text-foreground"
          >
            <ArrowLeft className="size-3.5" />
            Torna al blog
          </Link>
          ...
          <header className="mb-12 max-w-2xl">
            <p className="mb-3 text-xs font-bold uppercase tracking-[0.3em] text-primary">Argomento</p>
            <h1 className="text-3xl font-bold text-foreground sm:text-4xl">{tag}</h1>
